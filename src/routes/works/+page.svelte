...
<div class="min-h-[100vh]">
    ...
    <div class="w-full mt-[5rem] px-[10%]">
        <p class="font-cal text-[40px] tracking-[1px]">Works</p>
        ...
        <div in:fade={{ duration: 200 }} out:fade={{ duration: 200 }} class="w-full">
            ...
            {:else}
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 px-[10%] gap-4 mt-[2rem]">
                    {#each data as c}
                        <a href={c.website} class="shadow-based p-6 rounded-[15px] font-body hover:shadow-based-up transition-all duration-300 cursor-pointer border-neutral-800 dark:border-[1px] dark:hover:bg-neutral-900">
