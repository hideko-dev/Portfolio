...
<div class="fixed w-full left-0 top-0 p-3 font-writer-regular z-20">
    ...
    <div class="hidden md:flex items-center gap-0.5 w-full">
        ...
        {/if}
        <div class="ml-auto w-max flex items-center gap-0.5">
